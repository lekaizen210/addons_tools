...
def _Number_To_Word_Million(Number,lang): 
    ...
    if(Reste==1):
       ...
       if(Modulo ==0):
         ...
         Word=_Number_To_Word_10(Reste,lang)+' '+Number_Million[lang][1]  +' '+_Number_To_Word_10(Modulo,lang)
       elif(Modulo >=100 and Modulo< 1000):
         Word=_Number_To_Word_10(Reste,lang)+' '+ Number_Million[lang][1] +' '+_Number_To_Word_100(Modulo,lang)
       elif(Modulo >=1000 and Modulo< 1000000):
         Word=_Number_To_Word_10(Reste,lang)+' '+Number_Million[lang][1] +' '+_Number_To_Word_1000(Modulo,lang)
       else:
         pass
       ...
       if(Modulo ==0):
         ...
         Word=_Number_To_Word_100(Reste,lang)+' '+Number_Million[lang][1] +' '+_Number_To_Word_10(Modulo,lang)
       elif(Modulo >=100 and Modulo< 1000):
         Word=_Number_To_Word_100(Reste,lang)+' '+Number_Million[lang][1]  +' '+_Number_To_Word_100(Modulo,lang)
       elif(Modulo >=1000 and Modulo< 1000000):
         Word=_Number_To_Word_100(Reste,lang)+' '+Number_Million[lang][1] +' '+_Number_To_Word_1000(Modulo,lang)
       else:
         pass
